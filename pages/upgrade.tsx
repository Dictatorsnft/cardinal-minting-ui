...
function Home() {
  return (
    <div className="relative z-0 flex min-h-screen flex-col bg-black !important">
      <Head>
      ...
      <MainHero />
      <div className="z-10 mx-auto mt-0 flex grow flex-col gap-0 px-8 md:px-16">
        <div className="flex w-full flex-col text-center">
            <img src="/upgrade.gif" alt="" />
